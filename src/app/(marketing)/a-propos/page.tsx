...
const SECTEURS = [
  { icone: Building2, nom: "Agences", description: "Communication, conseil, événementiel — pipeline commercial et facturation au même endroit." },
  { icone: Wrench, nom: "Artisans", description: "Vocabulaire adapté (Chantier plutôt que Projet), du devis jusqu'au paiement Mobile Money." },
  { icone: Briefcase, nom: "Cabinets", description: "Dossiers clients permanents, missions bornées, documents sensibles protégés." },
  { icone: LayoutGrid, nom: "Toute autre entreprise de services", description: "Le tronc commun (CRM, facturation, RH, documents) s'adapte à votre activité." },
];
    ...
    <div className="mx-auto max-w-3xl px-6 py-20">
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2">
        {SECTEURS.map((secteur) => (
          <div key={secteur.nom} className="flex flex-col gap-2">
            <secteur.icone className="size-6 text-primary" aria-hidden />
