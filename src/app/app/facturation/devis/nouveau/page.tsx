...
export default async function PageNouveauDevis({
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="text-2xl font-semibold tracking-tight">{t("Nouveau devis")}</h1>
      ...
      <FormulaireDevis dealId={donnees.dealId ?? undefined} contactId={donnees.dealId ? undefined : donnees.contactId} produits={donnees.produits} />
    </div>
  );
}
