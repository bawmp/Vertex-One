...
export default function PageNouveauLead() {
  ...
  return (
    <Card className="max-w-lg">
      <CardHeader>
        <CardTitle>{t("Nouveau lead")}</CardTitle>
        <CardDescription>{t("Assigné à vous par défaut. À qualifier puis convertir en Contact/Deal.")}</CardDescription>
      </CardHeader>
      <CardContent>
        <form action={action} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="societeCliente">{t("Société (si B2B)")}</Label>
