...
import { creerTicketSupportPortail } from "@/lib/actions/portail";

export function FormulaireNouveauTicketPortail({ categories }: { categories: { id: string; nom: string }[] }) {
  const [etat, action, enCours] = useActionState(creerTicketSupportPortail, null);
