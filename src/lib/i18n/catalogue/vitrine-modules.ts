...
export const VITRINE_MODULES: Record<string, string> = {
  ...
  "Paiement en ligne Mobile Money (Orange Money, MTN MoMo) directement depuis la facture, via CinetPay": "Online Mobile Money payment (Orange Money, MTN MoMo) directly from the invoice, via CinetPay",
